...
class Lite3RearBalancePolicyRunnerONNX : public PolicyRunnerBase {
public:
    explicit Lite3RearBalancePolicyRunnerONNX(std::string policy_name);
    ~Lite3RearBalancePolicyRunnerONNX();
